...
- `publish-v2.yml` rebuilds a live-verified manifest in the protected
  `hermes-v2-production` environment, uploads the immutable object, and updates
...
architecture and rollout procedure.
